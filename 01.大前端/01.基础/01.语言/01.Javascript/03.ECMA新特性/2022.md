...
| 序号 | 语法   | 描述 |
| ---- | ------------- | ---------- |
| 1 | Top-level Await | 模块顶层作用域支持 await 表达式 | 
| 2 | class | 新增私有类元素；静态块；in 操作符支持私有类元素 |
| 3 | /reg/d | 新增 d 标志和其对应的 hasIndices 属性，提供了获取捕获组开始索引和结束索引的方法 |
| 4 | Error.cause | 新增 Error 实例的 cause 属性，增加错误可携带的信息 |
| 5 | Strings、Arrays、TypedArrays | 新增 at 方法，支持关联访问 |
| 6 | Object.hasOwn | 代替之前的 Object.prototype.hasOwnProperty，判断是对象是否含有属性 |
