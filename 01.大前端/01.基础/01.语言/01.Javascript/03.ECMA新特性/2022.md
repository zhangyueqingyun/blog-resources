...
ECMA2022 (ES13) 已经是 ECMAScript 语言的第 13 个版本啦！  
我们来看看这个版本为我们带来了哪些新特性吧！  
[[tc39-es13 原文链接](https://tc39.es/ecma262/)]
...
| 语法   | 描述 |
| ------------- | ---------- |
| Top-level Await | 模块顶层作用域支持 await 表达式 | 
| class | 新增私有类元素；静态块；in 操作符支持私有类元素 |
| /reg/d | 新增 d 标志和其对应的 hasIndices 属性，提供了获取捕获组开始索引和结束索引的方法 |
| Error.cause | 新增 Error 实例的 cause 属性，增加错误可携带的信息 |
