...
前两个章节我们介绍了 ReactElement 与 FiberRoot 的相关内容，今天我们将要开启第三步的介绍：元素树的渲染流程。

元素树的渲染是 React 框架的重点，它包含 Fiber 架构的实现（虚拟 dom）和对纤程的实现。这个章节我们主要介绍 Fiber 架构的一些前置知识点：“Fiber 架构和 FiberNode”。
