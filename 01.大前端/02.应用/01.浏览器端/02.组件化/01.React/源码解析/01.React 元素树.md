...
React 元素树是开发者和 React 交互的桥梁，元素树描述了目标网站的样子， React 会解析元素树，转化为Fiber 架构，生成交互式的网页。

React 元素是 $$typeof 属性为 REACT_ELEMENT_TYPE 的对象，它由 ReactElement 工厂函数创建。它还具有 type，key，ref，props 四个基本属性：
